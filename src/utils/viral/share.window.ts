...
export class ShareWindow {
	...
	dispose() {
		if (this.fbBtn) this.fbBtn.destroy(true);
		if (this.vkBtn) this.vkBtn.destroy(true);
		if (this.label) this.label.destroy(true);
		if (this.panel) this.panel.destroy(true);
		if (this.mask) this.mask.destroy(true);
		if (this.screenShot) this.screenShot.destroy(true);
