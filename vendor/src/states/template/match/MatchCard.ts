...
export class MatchCard {
	...
	public turnOn(): MatchCard {
		...
		TweenUtils.flipX(this.button, 0, 150, 0, () => {
			this.button.scale.setTo(0, 1);
			this.button.filters = null;
			TweenUtils.flipX(this.sprite, 1, 150, 0);
		}, this);
		return this;
	}
	
	public turnOff() {
		TweenUtils.flipX(this.sprite, 0, 150, 0, () => {
			this.button.inputEnabled = true;
			TweenUtils.flipX(this.button, 1, 150, 0);
		}, this);
	}
	...
	public glowSuccess() {
		this.isDone = true;
		this.sprite.filters = [EffectUtils.makeLightGlowAnimation(0x00ff00, 150, true, 1)];
		TweenUtils.fadeAndScaleOut(this.sprite, 250, 600);
	...
	public glowFailure() {
		this.sprite.filters = [EffectUtils.makeLightGlowAnimation(0xff0000, 150, true, 1)];
	}
