...
export class GFinger {
    ...
    constructor() {
        ...
        this.base = this.game.add.sprite(-220, -100,
        ...
        this.spot = this.game.add.sprite(-220, -100,
            ImageUtils.getAtlasClass('AtlasesWeaponGFinger').getName(),
            ImageUtils.getAtlasClass('AtlasesWeaponGFinger').Frames.Spot,
            this.container
        );
        this.spot.alpha = 0;
        this.ouch1 = this.game.add.sprite(-220, -100,
            ImageUtils.getAtlasClass('AtlasesWeaponGFinger').getName(),
            ImageUtils.getAtlasClass('AtlasesWeaponGFinger').Frames.Ouch1,
            this.container
        );
        this.ouch1.alpha = 0;
        this.ouch2 = this.game.add.sprite(-220, -100,
            ImageUtils.getAtlasClass('AtlasesWeaponGFinger').getName(),
            ImageUtils.getAtlasClass('AtlasesWeaponGFinger').Frames.Ouch2,
            this.container
        );
        this.ouch2.alpha = 0;
        this.web = this.game.add.sprite(-220, -100,
            ImageUtils.getAtlasClass('AtlasesWeaponGFinger').getName(),
            ImageUtils.getAtlasClass('AtlasesWeaponGFinger').Frames.Web,
            this.container
        );
        this.web.alpha = 0;
    ...
    private addKish(mob: MonsterType) {
        const k = this.game.add.sprite(-220, -100,
            ImageUtils.getAtlasClass('AtlasesWeaponGFinger2').getName(),
            ImageUtils.getAtlasClass('AtlasesWeaponGFinger2').Frames[mob + 'Kish'],
            this.kishContainer
        );
        k.alpha = 0;
